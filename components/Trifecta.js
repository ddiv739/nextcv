...
const Trifecta = () => (
            <Card className="trifecta">
                <CardHeader>The Professional's Trifecta</CardHeader>
                <CardBody>
                    <div className="row justify-content-center align-items-center lister">
                        <div className="col-sm hovfadein button" onClick={()=>{window.open("https://linkedin.com/in/dhruv-divekar")}}>
                        ...
                        <div className="col-sm" ><FiCode /></div>
                        <div className="col-sm hovfadein button" onClick={()=>{window.open("https://1drv.ms/b/s!AsTPUiKo9CTXgbxdapne8FZi8aVogQ")}}>
                        ...
                        <div className="col-sm " ><FiCode /></div>
                        <div className="col-sm hovfadein button" onClick={()=>{window.open("https://www.myequals.net/#/sharelink/76f312f8-923a-458d-948f-3d99e720ec23/f4ced532-9323-4ed2-be68-dad8180a9b6d")}}>

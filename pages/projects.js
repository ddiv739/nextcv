...
const Projects= () => (
    <BaseLayout>
      ...
      <CardDeck >
      <Card>
        <CardImg top width="100%" src="https://i.imgur.com/ag1izPj.jpg" alt="Humanoid next to stage." />
        <CardBody>
      ...
      <Card>
        <CardImg top width="100%" src="https://i.imgur.com/K1WMC2U.jpg" alt="Tensorflow placeholder image" />
        <CardBody>
